...
add("STDDEV SAMP縮約", "one", "SELECT STDDEV_SAMP(user_id) FROM users", "allow", "", "標本標準偏差への縮約を許可")
...
add("VAR SAMP縮約", "one", "SELECT VAR_SAMP(user_id) FROM users", "allow", "", "標本分散への縮約を許可")
...
add("COVAR POP縮約", "one", "SELECT COVAR_POP(user_id, amount) FROM users", "allow", "", "母共分散への縮約を許可")
add("BOOL AND縮約", "one", "SELECT BOOL_AND(user_id) FROM users", "allow", "", "論理積への縮約を許可")
add("BOOL OR縮約", "one", "SELECT BOOL_OR(user_id) FROM users", "allow", "", "論理和への縮約を許可")
